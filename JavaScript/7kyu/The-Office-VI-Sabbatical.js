// https://www.codewars.com/kata/57fe50d000d05166720000b1/javascript
...
function sabb(s, val, happiness) {
	return countSabbaticalLetters(s) + val + happiness > 22
		? "Sabbatical! Boom!"
		: "Back to your desk, boy.";
}

function countSabbaticalLetters(inputString) {
	const searchWord = "sabbatical";
	const searchLetters = new Set(searchWord.toLowerCase());

	let count = 0;

	for (const char of inputString.toLowerCase()) {
		if (searchLetters.has(char)) {
			count++;
		}
	}
