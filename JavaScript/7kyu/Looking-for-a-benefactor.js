// https://www.codewars.com/kata/569b5cec755dd3534d00000f/javascript
...
function newAvg(arr, newavg) {
  let arrSum = arr.reduce((sum, c) => sum + c, 0);
  let arrLen = arr.length;
  if ((arrLen + 1) * newavg - arrSum < 0) {
    throw new Error("Expected New Average is too low");
  } else {
    return Math.ceil((arrLen + 1) * newavg - arrSum);
  }
}