// https://www.codewars.com/kata/574be65a974b95eaf40008d
...
{    
    ...
    for(var i = 0; i < abcd_perms.length; i++)
    {
        ...
        {
            if(eval(`${abcd_perms[i][0]} ${oper_perms[j][0]} ${abcd_perms[i][1]} ${oper_perms[j][1]} ${abcd_perms[i][2]} ${oper_perms[j][1]} ${abcd_perms[i][3]}`) == 24){return `${abcd_perms[i][0]} ${oper_perms[j][0]} ${abcd_perms[i][1]} ${oper_perms[j][1]} ${abcd_perms[i][2]} ${oper_perms[j][1]} ${abcd_perms[i][3]}`;}
            if(eval(`(${abcd_perms[i][0]} ${oper_perms[j][0]} ${abcd_perms[i][1]}) ${oper_perms[j][1]} ${abcd_perms[i][2]} ${oper_perms[j][2]} ${abcd_perms[i][3]}`) == 24){return `(${abcd_perms[i][0]} ${oper_perms[j][0]} ${abcd_perms[i][1]}) ${oper_perms[j][1]} ${abcd_perms[i][2]} ${oper_perms[j][2]} ${abcd_perms[i][3]}`;}
            if(eval(`${abcd_perms[i][0]} ${oper_perms[j][0]} (${abcd_perms[i][1]} ${oper_perms[j][1]} ${abcd_perms[i][2]}) ${oper_perms[j][2]} ${abcd_perms[i][3]}`) == 24){return`${abcd_perms[i][0]} ${oper_perms[j][0]} (${abcd_perms[i][1]} ${oper_perms[j][1]} ${abcd_perms[i][2]}) ${oper_perms[j][2]} ${abcd_perms[i][3]}`;}
            if(eval(`${abcd_perms[i][0]} ${oper_perms[j][0]} ${abcd_perms[i][1]} ${oper_perms[j][1]} (${abcd_perms[i][2]} ${oper_perms[j][2]} ${abcd_perms[i][3]})`) == 24){return `${abcd_perms[i][0]} ${oper_perms[j][0]} ${abcd_perms[i][1]} ${oper_perms[j][1]} (${abcd_perms[i][2]} ${oper_perms[j][2]} ${abcd_perms[i][3]})`;}
            if(eval(`(${abcd_perms[i][0]} ${oper_perms[j][0]} ${abcd_perms[i][1]})${oper_perms[j][1]}(${abcd_perms[i][2]} ${oper_perms[j][2]} ${abcd_perms[i][3]})`) == 24){return `(${abcd_perms[i][0]} ${oper_perms[j][0]} ${abcd_perms[i][1]})${oper_perms[j][1]}(${abcd_perms[i][2]} ${oper_perms[j][2]} ${abcd_perms[i][3]})`;}
            if(eval(`(${abcd_perms[i][0]} ${oper_perms[j][0]} ${abcd_perms[i][1]} ${oper_perms[j][1]} ${abcd_perms[i][2]}) ${oper_perms[j][2]} ${abcd_perms[i][3]}`) == 24){return `(${abcd_perms[i][0]} ${oper_perms[j][0]} ${abcd_perms[i][1]} ${oper_perms[j][1]} ${abcd_perms[i][2]}) ${oper_perms[j][2]} ${abcd_perms[i][3]}`;}
