...
#function should be called "date-nb-days", but my compiler throws a fit
function calculate([int]$a0, [int]$a, [int]$p)
{
    $day = [Math]::Log10($a/$a0)/[Math]::Log10(1 + $p/36000)    
    return '{0:yyyy-MM-dd}' -f ([DateTime]"2016-01-01").AddDays($day + 1)
}